...
void lv_draw_manualLevel() {
  ...
  lv_obj_t *buttonPoint1 = lv_big_button_create(scr, "F:/bmp_leveling2.bin", leveling_menu.position2, INTERVAL_V, titleHeight, event_handler, ID_M_POINT2);
  lv_obj_clear_protect(buttonPoint1, LV_PROTECT_FOLLOW);
  lv_big_button_create(scr, "F:/bmp_leveling5.bin", leveling_menu.position5, BTN_X_PIXEL + INTERVAL_V * 2, BTN_Y_PIXEL/2 + INTERVAL_H + titleHeight, event_handler, ID_M_POINT5);
  ...
  lv_big_button_create(scr, "F:/bmp_leveling1.bin", leveling_menu.position1, INTERVAL_V, BTN_Y_PIXEL + INTERVAL_H + titleHeight, event_handler, ID_M_POINT1);
  lv_big_button_create(scr, "F:/bmp_leveling4.bin", leveling_menu.position4, BTN_X_PIXEL * 2 + INTERVAL_V * 3, BTN_Y_PIXEL + INTERVAL_H + titleHeight, event_handler, ID_M_POINT4);
