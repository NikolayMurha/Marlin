...
void gCfgItems_init() {
  ...
  gCfgItems.trammingPos[1].x  = X_MIN_POS + 30; // BL
  gCfgItems.trammingPos[1].y  = Y_MAX_POS - 30; // BL 
  gCfgItems.trammingPos[2].x  = X_MAX_POS - 30; // BR
  gCfgItems.trammingPos[2].y  = Y_MAX_POS - 30; // BR
  gCfgItems.trammingPos[3].x  = X_MAX_POS - 30; // FR
  gCfgItems.trammingPos[3].y  = Y_MIN_POS + 30; // FR
